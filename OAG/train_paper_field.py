...
if __name__ == "__main__":
    ...
    for epoch in tqdm.tqdm(np.arange(args.n_epoch) + 1):
        ...
        for _ in range(args.repeat):
            # node_feature:[3606, 1169] node_type:[3606], edge_time:[32587], edge_type:[32587] x_ids[256] ylabel:[256, 17729]
            # node_feature:[3620, 1169] node_type:[3620], edge_time:[31872], edge_type:[31872] x_ids[256] ylabel:[256, 17729]
        ...
        model.eval()
        with torch.no_grad():
            # node_feature:[3606] node_type:[3606] edge_index:[32587] x_ids:[256] ylabel:[256, 17729]
            ...
            if valid_ndcg > best_val:
                ...
                if best_val>0.3:
                    ipdb.set_trace()
                torch.save(model.state_dict(), os.path.join(args.model_dir, args.task_name + '_' + args.conv_name)+'.pth')
                print('UPDATE!!!')
